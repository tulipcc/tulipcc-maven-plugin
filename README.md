...
Supported goals with the respective parameters are:
  ...
  * `jjtree` -  parses a JJTree grammar file (`*.jjt`) and transforms it to Java source files and a JavaCC grammar file. Please see the [JJTree Reference Documentation](https://javacc.org/jjtree) for more information.
...
# Developer info
  ...
  * Java CC sources are at [javacc@github](https://github.com/javacc/javacc)
