...
public class NfaStateTest extends JavaCCTestCase
{
  ...
  {
    final JavaCCParser parser = new JavaCCParser (new java.io.BufferedReader (new java.io.InputStreamReader (new java.io.FileInputStream (parserInput),
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState#CanStartNfaUsingAscii(char)}.
   */
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState#getFirstValidPos(java.lang.String, int, int)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState#MoveFromSet(char, java.util.Vector, java.util.Vector)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState# moveFromSetForRegEx(char, org.javacc.parser.NfaState[], org.javacc.parser.NfaState[], int)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState# GenerateInitMoves(java.io.PrintWriter)}.
   */
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState# DumpStateSets(java.io.PrintWriter)}.
   */
  ...
  public void testDumpNonAsciiMoveMethods ()
  {
    ...
    assertEquals ("", cg.getGeneratedCode ().trim ());
  }
  ...
  /**
   * Test method for
   * {@link org.javacc.parser.NfaState# DumpStatesForState(java.io.PrintWriter)}
   * .
   */
  ...
  public void testDumpStatesForKind ()
  {
    ...
    assertEquals ("protected static final int[][][] statesForState = null;\n"
                  + "protected static final int[][] kindForState = null;", cg.getGeneratedCode ()
                                                                             .replaceAll ("\r", "")
                                                                             .trim ());
  }
